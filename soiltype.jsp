...
String farmername=(String) session.getAttribute("farmer");
%>
<body>
...
<li class="current_page_item"><a href="soiltype.jsp" accesskey="2" title="">Soil Type</a></li>
...
ResultSet rs=st.executeQuery("select * from farmer where username='"+username+"'");//farmer username,soiltype-jobsapply
